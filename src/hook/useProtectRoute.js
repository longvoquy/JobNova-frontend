...
const ProtectedRoute = ({ element: Component, ...rest }) => {
  const token = localStorage.getItem('token');
  const publicPages = ['/index-two', '/job-categories', '/job-grid-two', '/job-list-one', '/aboutus', '/services', '/pricing', '/helpcenter-overview', '/helpcenter-faqs', '/helpcenter-guides', '/helpcenter-support', '/blogs', '/blog-sidebar', '/blog-detail', '/blog-detail/:id'];
